...
For the calorimeter set of data, the L1 first generates trigger primitives by looking for large energy deposits in the calorimter.
...
This framework is flexible alloweing both the HLT software and the processor farm to be updated in order to meet changing experimental needs.
