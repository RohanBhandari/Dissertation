...
\begin{figure}[tbp!]
\centering
\includegraphics[angle=0,width=0.40\columnwidth]{fig/prefit_nlep1_nj67_highmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/prefit_nlep1_nj67_vhighmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/prefit_nlep1_nj8_lowmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/prefit_nlep1_nj8_highmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/prefit_nlep1_nj8_vhighmj.pdf}
...
\begin{figure}[tbp!]
\centering
\includegraphics[angle=0,width=0.40\columnwidth]{fig/bonly_nlep1_nj8_lowmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/bonly_nlep1_nj67_highmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/bonly_nlep1_nj8_highmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/bonly_nlep1_nj67_vhighmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/bonly_nlep1_nj8_vhighmj.pdf}
\caption{Data and the background-only post-fit \Nb distribution for the signal region bins: $\Njets \geq 8$, $500 < \MJ \leq 800~\GeV$ (upper-left), $6 \leq \Njets \leq 7$, $800 < \MJ \leq 1000~\GeV$ (upper-right), $\Njets \geq 8$, $800 < \MJ \leq 1000~\GeV$ (middle-left), $ 6 \leq \Njets \leq 7$, $\MJ > 1000~\GeV$ (middle-right), and $ \Njets \geq 8$, $\MJ > 1000~\GeV$ (bottom-middle).
The expected signal distribution is also shown for a gluino mass of 1600~\GeV.
The ratio of data to post-fit yields is shown in the lower panel.
The post-fit uncertainty is depicted as a hatched band.}
\label{fig:bonly_sr}
...
\begin{figure}[tbp!]
\centering
\includegraphics[angle=0,width=0.40\columnwidth]{fig/splusb_nlep1_nj8_lowmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/splusb_nlep1_nj67_highmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/splusb_nlep1_nj8_highmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/splusb_nlep1_nj67_vhighmj.pdf}
\includegraphics[angle=0,width=0.40\columnwidth]{fig/splusb_nlep1_nj8_vhighmj.pdf}
